...
public class MD5Util {
	...
	/*public static void main(String[] args) {
		...
		// String salt ="1";
		//String encodeString = password + salt;


		String encodeByAES = encodeByAES(password);
		String decodeByAES = decodeByAES("97998E5FA4113E47168ECE15FB43051F");

		int length= encodeByAES.length();
